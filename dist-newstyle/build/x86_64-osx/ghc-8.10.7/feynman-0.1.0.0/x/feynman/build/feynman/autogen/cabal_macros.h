...
/* package feynman-0.1.0.0 */
#ifndef VERSION_feynman
#define VERSION_feynman "0.1.0.0"
#endif /* VERSION_feynman */
#ifndef MIN_VERSION_feynman
#define MIN_VERSION_feynman(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_feynman */
...
#define CURRENT_COMPONENT_ID "feynman-0.1.0.0-inplace-feynman"
